...
# Which payload range(s) has the highest launch success rate? 0-7500KG range has the highest launch success rate

# Which payload range(s) has the lowest launch success rate? 7500 to 10000KG range has the lowest launch success rate
